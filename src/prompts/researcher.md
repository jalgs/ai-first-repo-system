...
## Output
Always use the `writeReportTool` to save your report to `researcher-report.md` before responding to the Director. Do not output the full text of the report in your chat response.
